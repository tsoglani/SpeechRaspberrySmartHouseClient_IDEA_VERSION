...
public class AddNewShedule extends JPanel
{
    ...
    private  int min=0,hours=0,sec;
    private  JButton back;
    JComboBox commandCombo ;
    private ImageIcon cancelIcon;
    public AddNewShedule(Fr fr,String selectedString)
    {
        ...
        commandCombo.addItemListener(new ItemListener() {
                ...
                public void itemStateChanged(ItemEvent e) {
                    if (e.getStateChange() == ItemEvent.SELECTED) {
                        ...
                        if(SheduleView.selectedOption!=null&&SheduleView.selectedOption.startsWith("createByDeviceGUI"))
                        SheduleView.selectedOption="createByDeviceGUI"+commandCombo.getSelectedItem().toString();
                        commandCombo.setFont(new Font(fontName, Font.BOLD, 20));
                    }
                }
            });
        ...
        hourSlider.addChangeListener(new ChangeListener(){
                public void stateChanged(ChangeEvent changeEvent) {
                    ...
                    timeLabel.setText(hoursString+":"+minString+":"+secString);
...
minLabel.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 20));
        secLabel.setFont(new Font("Verdana", Font.BOLD | Font.ITALIC, 20));
...
///add:::CommandText:kitchen lights##ActiveDays:1 off2 on3 on##ActiveTime:00:00##IsWeekly:true##IsActive:true



                    String CommandText="CommandText:"+commandCombo.getSelectedItem().toString()+fr.sh.db.COMMAND_SPLIT_STRING+fr.sh.db.DAYS_STRING
